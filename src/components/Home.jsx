...
const Home = ({ languaje }) => {
  return (
    <>
      <div className=" pt-28 ml-10 w-3/4 lg:grid lg:grid-cols-2 lg:w-full lg:pt-36" id="home">
        <div className=" sm:flex sm:flex-col sm:items-center lg:flex lg:items-start lg:ml-[10vw] ">
          ...
          <div className=" flex space-x-4 items-center my-5 lg:mt-12 ">
            ...
            <img className=" cursor-pointer w-8 h-8 aspect-square" src={github} />
            </a>
        ...
        <div className=" space-y-4 lg:w-3/4 lg:mt-16 lg:pl-10">
          ...
          <div className="cursor-pointer flex flex-col justify-start items-center space-y-2 lg:space-y-0 sm:text-xl lg:flex-row lg:text-base lg:space-x-6  ">
            <a className="bg-[#222222] p-3 px-6 my-3 rounded-full sm:p-4 sm:px-8 lg:py-3  ">
              {languaje.home.calltoaction1}
            </a>
            <a href="#projects" className="cursor-pointer bg-[#222222] p-2 px-8 my-3 rounded-full sm:p-3 sm:px-10 ">
