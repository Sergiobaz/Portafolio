const AboutMe = ({ languaje }) => {
  return (
    <div className=" pt-20 mx-12 " id="about">
      <div className="">
        <div className="border relative top-6 right-12 w-12 lg:w-52"></div>
        ...
        <div className="mr-5 mt-8 text-sm ml-4 border-l pl-5 py-4 lg:w-2/4 lg:border-none lg:ml-80">
